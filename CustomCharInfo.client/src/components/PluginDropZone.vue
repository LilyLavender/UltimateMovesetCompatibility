    ...
    >
      ...
      <template v-else>
        ...
        <div class="drop-label-group">
          ...
          <span v-else-if="hashValue" class="drop-sub-inline drop-sub-inline--hash">SHA-256: {{ hashValue }}</span>
        </div>
        <v-icon size="18" class="clear-icon" @click.stop="clear">mdi-close</v-icon>
      </template>
    </div>
...
<style scoped>
.drop-wrap { display: flex; flex-direction: column; gap: 0.35rem; }
...
.drop-zone--active { border-color: #64b5f6; background-color: #16232b; }
.drop-zone--has-file { border-style: solid; border-color: #388e3c; background-color: #142614; }
.drop-zone--duplicate { border-style: solid; border-color: #f9a825; background-color: #2e2400; }
.drop-zone--large { padding: 1.5rem 1.5rem; min-height: 90px; }

.hidden-input { display: none; }

.drop-icon { flex-shrink: 0; color: #888; }
.drop-zone--has-file .drop-icon { color: #81c784; }
.drop-icon--duplicate { color: #ffb300; }
...
.drop-zone--duplicate .drop-label-group .drop-label { color: #ffe082; }
.drop-zone--has-file .drop-label-group .drop-label { color: #c8e6c9; }
...
.drop-zone--duplicate .drop-sub-inline { color: #cbb27a; }
.drop-zone--has-file .drop-sub-inline { color: #a5d6a7; }
...
.drop-sub { font-size: 0.8em; color: #777; margin-left: auto; flex-shrink: 0; }
.clear-icon { margin-left: auto; color: #999; flex-shrink: 0; align-self: flex-start; }
